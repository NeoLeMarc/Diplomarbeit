...
\section{Der \emph{Analog Devices ADuC702X} Mikrocontroller}
    ...
    \nomenclature{ARM}{RISC-Prozessorarchitektur, die an verschiedene Hersteller in Lizenz implementiert wird.}
...
def sendeBefehl(befehl)
    ...
    if statusString == 'OK':
        ...
        \subsection{Behandlung asynchron auftretender Ereignisse}
            ...
            Nachteile:
            \nomenclature{Deadlock}{Nichtmehr zu behebende Verklemmung von mindestens zwei \emph{Threads}}
