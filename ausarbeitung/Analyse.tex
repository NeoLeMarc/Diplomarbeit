...
\section{Der \emph{Analog Devices ADuC702X} Mikrocontroller}
    ...
    \nomenclature{ARM}{RISC-Prozessorarchitektur, die von verschiedene Hersteller in Lizenz gefertigt wird.}
    ...
    \nomenclature{AT-Befehlssatz}{Satz von Befehlen, die ursprünglich für Modems entwickelt wurden.}
    ...
    Zentrale Komponente des \emph{Erste-Hilfe-Sensor}, welcher die Grundlage für die Sensoren im zu entwerfenden Netzwerk
    bildet, ist der \emph{ADuC-7022}-Mikrocontroller. Es handelt sich hierbei um einen Vertreter einer ganzen Familie
    von Mikrocontrollern der Firma \emph{Analog Devices}. Im folgenden eine kurze Übersicht über die Eigenschaften
...
\section{Die Atmel ZigBit Familie}
    ...
    ein Modul der Firma \emph{Atmel} getroffen, da diese nicht nur die günstigsten betrachteten Module waren,
    ...
    \subsection{Firmware}
        ...
        \subsubsection{SerialNet}
            ...
            \paragraph{Überblick}
                ...
                \emph{SerialNet} ist eine \emph{BitCloud} basierte \emph{Firmware}, die von Atmel als fertiges Image angeboten
            ...
            \paragraph{SerialNet AT-Protokoll}
                ...
                \begin{itemize}
                    \item{\emph{offline}:} Es besteht keine Verbindung zu eine \emph{ZigBee}-Netzwerk. Befehle
...
def sendeBefehl(befehl)
    ...
    if statusString == 'OK':
        ...
        return False
            ...
            \begin{enumerate}
                \item{Asynchron auftretende Ereignisse:} Die Abarbeitung eines \emph{SerialNet}-Befehls kann 
                          ...
                          \emph{Timeout} aufgetreten ist}. Während das Steuerungprogramm auf die Quittierung des 
        ...
        \subsection{Behandlung asynchron auftretender Ereignisse}
            ...
            Befüllens der Ereigniswareteschlange vorgenommen, während von einem anderen \emph{Thread} aus diese Warteschlange
...
def sendeBefehl(befehl)
    ...
    \section{Powermanagement}\label{analyse_powermanagement}
        ...
        (also auch auf \emph{Routern} und \emph{Coordinatoren}) gleich sein sollte. Der eigentliche Energeisparmodus steht
