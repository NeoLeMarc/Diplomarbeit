...
\chapter{Pläne und Diagramme}\label{anhang_diagramme}
    ...
    \Abbildungps{!htb}{1}{diagramme/schaltplan_manvnode_power-crop.pdf}{label}{Schaltplan der \emph{MANVNode}: Stromversorgung.}
    \Abbildungps{!htb}{0.5}{diagramme/schaltplan_manvnode_jtag-crop.pdf}{label}{Schaltplan der \emph{MANVNode}: \emph{JTAG}.}
    \Abbildungps{!htb}{1}{diagramme/schaltplan_manvnode_aduc-crop.pdf}{label}{Schaltplan der \emph{MANVNode}: Mikrocontroller.}
    \Abbildungps{!htb}{1}{diagramme/schaltplan_manvnode_zigbit-crop.pdf}{label}{Schaltplan der \emph{MANVNode}: \emph{ZigBit}-Modul.}
    \Abbildungps{!htb}{1}{diagramme/schaltplan_manvnode_interface-crop.pdf}{label}{Schaltplan der \emph{MANVNode}: Benutzerschnittstelle.}
    ...
    \Abbildungps{!htb}{1.15}{uml_diagramme/manvconnector_uml_links.pdf}{label}{Klassendiagramm des \emph{MANV-Connectors} (Linke Seite)}
    \Abbildungps{!htb}{1.15}{uml_diagramme/manvconnector_uml_rechts.pdf}{label}{Klassendiagramm des \emph{MANV-Connectors} (Rechte Seite)}

    \begin{sidewaysfigure}
            \includegraphics*[width=1\textwidth]{uml_diagramme/manvconnector_uml.pdf}
            \caption{Klassendiagramm des MANV-Connectors (Vollständig).}
