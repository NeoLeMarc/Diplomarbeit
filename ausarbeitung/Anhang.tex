...
\chapter{Pläne und Diagramme}\label{anhang_diagramme}
    ...
    \Abbildungps{!htb}{1.20}{uml_diagramme/manvconnector_uml_links.pdf}{label}{Klassendiagramm des \emph{MANV-Connectors} (Linke Seite)}
    \Abbildungps{!htb}{1.20}{uml_diagramme/manvconnector_uml_rechts.pdf}{label}{Klassendiagramm des \emph{MANV-Connectors} (Rechte Seite)}
