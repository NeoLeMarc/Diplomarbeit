...
\chapter{Beschreibung der beigelegten Software}\label{anhang_beschreibung_software}
    ...
    \subsubsection{Inhalt des Verzeichnisses \emph{events/}}\label{anhang_events}
    ...
    \subsubsection{Inhalt des Verzeichnisses \emph{lib/}}\label{anhang_lib}
    ...
    \paragraph{Interface eines ZigBit-Knotens}\label{anhang_zigbit}

    Das \emph{Interface} eines \emph{ZihBit}-Knotens definiert folgende Methoden:
