...
\nomenclature{Replay}{Attacke, bei der legitime Datenpakete abgefangen, und zu einem späteren Zeitpunkt wieder ins
...
\nomenclature{Denial-Of-Service}{Blockieren eines Dienstes durch Ausnutzen eines Softwarefehlers.}
