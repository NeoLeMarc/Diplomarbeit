...
\Abbildungps{!htb}{1}{diagramme/versuchsaufbau_integrationstest.pdf}{integrationstest_setup_diagramm}{Diagramm des Aufbaus des \emph{Integrationstests}.}
\Abbildungps{!htb}{1}{diagramme/integrationstest_setup.jpg}{integrationstest_setup_photo}{Photo des Aufbaus des \emph{Integrationstests}.}
...
stattfinden musste. Nun wurden alle obigen Tests noch einmal wiederholt. Der genaue Aufbau dieses Versuchs kann dem
Diagramm in Abbildung~\ref{integrationstest_setup_diagramm} entnommen werden.
...
\nomenclature{JSON}{Javascript-basiertes Datenübertragungsformat von Webservern zu \emph{Webbrowsern}.}
