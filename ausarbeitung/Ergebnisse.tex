...
\Abbildungps{!htb}{1}{diagramme/integrationstest_setup.jpg}{intergrationstest_setup}{Aufbau des \emph{Integrationstests}.}
...
\nomenclature{Virtuelle~Maschine}{In Software virtuell implementierter Computer.}
...
sowie dem Einsatz von Hardwarevirtualisierung jede Komponente auf eine eigene \emph{Virtuelle Maschine} installiert. Diese
...
\nomenclature{Symbian}{Betriebssystem für ein Nokia Handy.}
...
\nomenclature{Multimeter}{Mehrzweckmessgerät das unter anderem Strom und Spannung messen kan.}
\nomenclature{Oszilloskop}{Messgerät zur optischen Darstellungen von zeitlichen Spannungsverläufen.}
...
\Abbildungps{!htb}{0.75}{oszi/normalbetrieb_client.jpg}{oszi_normalbetrieb_client}{Endknotens im Normalbetrieb ohne Energiesparmodus. 
%        Auffällig sind die \emph{Peaks}, in denen sich der Knoten im Empfangsmodus befindet. 
%        Die \emph{Peaks} haben eine 
%    Länge von 40~ms und einen Betrag von 23,4~mA. Ausserhalb eines \emph{Peaks} beträgt der Stromverbrauch 10,7~mA.
%    Insgesamt ergibt 
...
\subsection{Leistungsaufnahme bei Verwendung des Energiesparmoduses.}
...
Abbildung~\ref{oszi_erwachen} zu sehen ist, sinkt der Stromverbrauch während des Energiesparmoduses auf praktisch 
...
\Abbildungps{!htb}{0.75}{oszi/not_joined.jpg}{oszi_not_joined}{Client mit deaktiviertem Empfangsmodus.
    %deaktiviert. Der 
    %Stromverbrauch beträgt konstant 10,7~mA.}
    }
