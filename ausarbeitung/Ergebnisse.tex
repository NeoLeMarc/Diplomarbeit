...
Sensornetzwerk implementiert. Dieses muss nun zunächst mit Daten aus dem Sensornetzwerk versorgt werden. Hierzu
findet das sogenannte \emph{JSON}-Format Verwendung. Außerdem muss es möglich sein, Befehle an das
...
des Spannungsverlaufs bestimmt, für die nun der Wert der abfallenden Spannung gemessen wurde. Über das Ohmsche Gesetz 
