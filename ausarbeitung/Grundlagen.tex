...
\section{Grundlagen der kabellosen Übetragung}
    ...
    \subsection{Frequenzspreizung}
        \Abbildungps{!htb}{1}{diagramme/frequenzspreizung_fhss.pdf}{frequenzspreizung_fhss}{Frequenzspreizung mit dem \emph{FHSS}-Verfahren}
        \Abbildungps{!htb}{1}{diagramme/frequenzspreizung_dss.pdf}{frequenzspreizung_dsss}{Frequenzspreizung mit dem \emph{DSSS}-Verfahren}
