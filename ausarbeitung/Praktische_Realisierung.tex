...
In diesem Kapitel wird die Implementierung des Sensornetzwerkes beschrieben, welche Probleme dabei aufgetreten
...
\nomenclature{Crossworks}{Entwicklungsumgebung für Mikrocontroller-Firmware.}
...
\emph{Timer0}: Dieser Timer-Interrupt führt die Patientenüberwachung durch. Die einzelnen Sensoren werden abgefragt,
...
\emph{Timer1}: Dieser Interrupt führt einige periodische Aufgaben durch. Zunächst werden die am Sensor vorhandenen
...
FÜr das Empfangen wird das Register \emph{COMRX} in analoger Weise verwendet werden. Ob das nächste
...
\nomenclature{Socket}{Softwareabstratkion einer Netzwerkverbindung, die sich verhält wie ein Dateizugriff.}
...
\emph{Debuggen}{Suchen und entfernen von Fehlern.}
...
\emph{ZigBit-USB-Stick}, zwei weitere dienten zum \emph{Flashen} und \emph{Debuggen} der angeschlossenen Mikrocontroller.}, 
