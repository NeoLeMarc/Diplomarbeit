...
die zur Überwachung von Patienten in einem \glossary{MANV}-Szenario in Frage kommen vorgestellt, und die Eignung dieser
    ...
    \subsection{WPAN: Wireless Personal Area Networks}
        ...
        \subsubsection{IEEE 802.15.4: ZigBee}
            ...
            \paragraph{Störsicherheit}
                ...
                \nomenclature{Beacon}{dt. Leucht}feuer -- periodisches Bekanntmachen des Vorhandenseins des Netzwerkes.}
                ...
                dass eine \emph{CRC}-Verfahren keinen Schutz gegen absichtliche Manipulation bietet. Diese können
