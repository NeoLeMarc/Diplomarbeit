...
main(void)
{
  ...
  // Write banner
  printf("Welcome to MANV-Firmware\n");
  printf("(C) Copyright 2010 by IBT-Karlsruhe [http://www.ibt-karlsruhe.de]\n");
  printf("(A) Author 2010: Marcel Noe <marcel@marcel-noe.de>\n");
  printf("\n");
