...
\begin{frame}
   \frametitle{Die Nervenzelle (Neuron)} 
    \includegraphics[width=12cm]{images/Neuron_Hand-tuned-text.jpg}
\end{frame}

\begin{frame}
    \frametitle{Der synaptische Spalt}
    \begin{center}
...
\begin{frame}
    \frametitle{Das Aktionspotential}
    \begin{center}
...
\begin{frame}
    \frametitle{Anatomie des Herzens}
    \begin{center}
...
\begin{frame}
    \frametitle{Reizleitungssystem im Herzen}
    \begin{columns}
        \begin{column}{5cm}
        ...
        \begin{column}{7cm}
            \begin{itemize}
                ...
                \item Sinusknoten: 40-200 Schläge pro Minute 
                \item AV-Knoten: 40-50 Schläge pro Minute
                \item His-Bündel: 20-30 Schläge pro Minute
            \end{itemize}
        \end{column}
    \end{columns}
...
\begin{frame}
    ...
    \begin{columns}
        ...
        \begin{column}{6cm}
            \begin{itemize}
                \item "50Hz Brummen"
                \item Kapazitive Einkopplung (Unglücklicherweise direkt in den Patienten \\$\rightarrow$ Schirmung wirkungslos)
                \item Unzureichend geglättete Versorgungsspannung \\$\rightarrow$ Batterien, Kondensatorglättung, Galvanische Trennung
...
\begin{frame}
    ...
    \begin{columns}[T]
        ...
        \begin{column}{7cm}
            \begin{itemize}
                \item 12 Kanäle:
                \item Einthoven I, II, III (Extremitäten)
                \item Goldberger aVR, aVL, aVF (Extremitäten)
...
\begin{frame}
    ...
    \begin{center}
        \includegraphics[width=12cm]{images/defi_house.jpg}
    \end{center}
\end{frame}
    ...
    \begin{columns}[T]
        ...
        \begin{column}{7cm}
            \begin{itemize}
                ...
                \item 1,5 Ampere 
                \item 750 Volt 
                \item Depolarisierung von über 70\% des Myokards
            \end{itemize}
...
\begin{frame}
    \frametitle{Der Herzschrittmacher}
    \begin{center}
        \includegraphics[width=6cm]{images/herzschrittmacher.png}
    \end{center}
\end{frame}
...
\begin{frame}
    ...
    \begin{columns}[T]
        ...
        \begin{column}{7cm}
            \begin{itemize}
                \item 1. Grad: Erregungsleitung verzögert 
                \item 2. Grad: 2:1, 3:1 oder 4:1 Block 
                \item 3. Grad: Keine Übertragung mehr zwischen Vorhof und Kammern 
            \end{itemize}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}
    ...
    \begin{columns}[T]
        \begin{column}{6cm}
            \includegraphics[width=6cm]{images/fractal2.jpg}
        \end{column}

        \begin{column}{7cm}
            \begin{itemize}
                \item Ag-AgCl Elektroden im Körper toxisch. 
                \item Vergrößerung der Oberfläche durch\\ Fraktale
                \item $\rightarrow$ Vergrößerung der Helmholtz-Doppelschicht
                \item $\rightarrow$ Rein kapazitive Einkopplung in Gewebe
                \item $\rightarrow$ Elektrode nicht polarisierbar
            \end{itemize}
        \end{column}
    \end{columns}
