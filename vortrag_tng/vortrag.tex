...
\begin{frame}
    ...
    \includegraphics[height=4.5cm]{images/defi.jpg}
    \includegraphics[height=4.5cm]{images/aed.jpg}
\end{frame}

\begin{frame}
    \frametitle{Biphasischer Schock} 
    \includegraphics[width=6cm]{images/electrode_position.jpg}
    \includegraphics[width=6cm]{images/shock.png}
\end{frame}
